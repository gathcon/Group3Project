...
public class TestBaseDataConfig extends AbstractTestConfig {
	...
	public void testCreateDeleteRow() {
		...
		Base_Data expected = EntityCreator.getBase_Data(10, 4, dateTime, 1000, hier3Id, hier32Id, hier321Id, imsi, neVersion, f, ue, ec, o);
	...
	public void testList() {
		...
		Base_Data row = EntityCreator.getBase_Data(15, 4, dateTime, 1000, hier3Id, hier32Id, hier321Id, imsi, neVersion, f, ue, ec, o);
		Base_Data row2 = EntityCreator.getBase_Data(11, 4, dateTime, 1001, hier3Id, hier32Id, hier321Id, imsi, neVersion, f2, ue2, ec2, o2);
